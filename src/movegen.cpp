...
#ifdef NANOHA
template MoveStack* generate<MV_CAPTURE>(const Position&, MoveStack*);
template MoveStack* generate<MV_NON_CAPTURE>(const Position&, MoveStack*);
template MoveStack* generate<MV_NON_EVASION>(const Position&, MoveStack*);
#else
